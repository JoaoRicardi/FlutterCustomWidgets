...
import 'package:flutter_architecture_rx/src/custom_widgets/divider_field.dart';
          ...
          children: <Widget>[
            Row(
              ...
              children: <Widget>[
                  ...
                  children: <Widget>[
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        border: Border.all(
                          color: status == true ? colors.accentColor : colors.listTextDisabledColor,
                          width: 2
                        ),
                      ),
                    ),
                ...
                CustomText(text: label ?? "Label",accent: true,),
              ]
            ),
